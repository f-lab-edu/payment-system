...
> 평소 돈의 흐름에 관심이 많아 금융 거래의 흐름과 결제 시스템 구조를 파악하고자 카카오와 토스의 결제 api를 연동한 결제 시스템을 구현했습니다.
> 기술적으로는 분산시스템에서의 신뢰성 있는 결제 시스템을 제공하는 것을 목적으로 개발했습니다.
...
- 신뢰성 있는 결제 시스템을 위한 동시성 이슈 고려, 성능과 신뢰성의 trade-off 관계 고민하기
- 로그인 기능 고민 (아래 둘 중 선택)
